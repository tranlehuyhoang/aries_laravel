            ...
            <div class="container container--max--xl">
                <div class="py-5">
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-auto d-flex"><a href="{{ route('admin.blog') }}"
                            class="btn btn-secondary me-3">Back</a><a id="submit_button"  href="#"
                            class="btn btn-primary">Save</a></div>
                </div>
                        {{-- <div class="col-auto d-flex"><a  onclick="history.back()" class="btn btn-secondary me-3">Back</a>
