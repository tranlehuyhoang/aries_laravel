            ...
            <div class="sa-invoice__card">
                <div class="sa-invoice__header">
                    <div class="sa-invoice__meta">
                        <div class="sa-invoice__title">Hóa đơn SA-{{ $order['ID'] }}</div>
                        <div class="sa-invoice__meta-items"><span>Ngày tạo:</span>
                            {{ $order_data['created_at'] }}<br /><span>Ngày cập nhật:</span>
                ...
                <div class="sa-invoice__sides">
                    <div class="sa-invoice__side">
                        <div class="sa-invoice__side-title">Hóa đơn đến</div>
                    ...
                    <div class="sa-invoice__side">
                        <div class="sa-invoice__side-title">Hóa đơn từ</div>
                        <div class="sa-invoice__side-name">Aries Ltd.</div>
                        <div class="sa-invoice__side-meta">345 Pham Van Dong Street, HN city 10021 VN<br />+0 800 306-8265,
                            loinguyen.cool@gmail.com</div>
                    </div>
                </div>
                <div class="sa-invoice__table-container">
                    <table class="sa-invoice__table">
                        <thead class="sa-invoice__table-head">
                            <tr>
                                <th class="sa-invoice__table-column--type--product">Sản phẩm / Dịch vụ</th>
                                <th class="sa-invoice__table-column--type--unit">Đơn vị</th>
                                <th class="sa-invoice__table-column--type--price">Giá</th>
                                <th class="sa-invoice__table-column--type--quantity">Số lượng</th>
                                <th class="sa-invoice__table-column--type--total">Tổng cộng</th>
                            </tr>
                        </thead>
                        ...
                        <tbody class="sa-invoice__table-body">
                            ...
                            @foreach ($order_items as $item) 
                                <tr>
                                    ...
                                    <td class="sa-invoice__table-column--type--unit">Sản phẩm</td>
                                    <td class="sa-invoice__table-column--type--price">${{ $item->price }}.00
                                    </td>
                        ...
                        <tbody class="sa-invoice__table-totals">
                            <tr>
                                <th class="sa-invoice__table-column--type--header" colSpan="4">Tạm tính</th>
                                <td class="sa-invoice__table-column--type--total">
                                    ${{ number_format($sbtotal) }}.00</td>
                            </tr>
                            <tr>
                                <th class="sa-invoice__table-column--type--header" colSpan="4">Phí ship (VAT 1%)</th>
                                <td class="sa-invoice__table-column--type--total">
                                    ${{ number_format($order_data['shipping_price']) }}.00</td>
                            </tr>
                            <tr>
                                <th class="sa-invoice__table-column--type--header" colSpan="4">Giảm giá</th>
                ...
                <div class="sa-invoice__total">
                    <div class="sa-invoice__total-title">Thánh tiền:</div>
                    <div class="sa-invoice__total-value">
                        ${{ number_format(  $order_data['total_amount']) }}.00</div>
