              ...
              <div class="sa-sidebar__header">
                  <a class="sa-sidebar__logo" href="{{ route('home', ['id' => 1]) }}">
                      ...
                      <div class="sa-sidebar-logo">
                          ...
                          {{-- <svg version="1.1" x="0px" y="0px" width="120px" height="42.52px" viewBox="0 0 175.748 42.52"
                              enable-background="new 0 0 175.748 42.52" style="margin-bottom: 0;">
                      ...
                      <li class="sa-nav__section">
                          ...
                          <ul class="sa-nav__menu sa-nav__menu--root">
                              <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"><a
                                      href="{{ route('dashboard') }}" class="sa-nav__link"><span
                                          ...
                                          </svg></span><span class="sa-nav__title">Thống kê</span></a></li>
                              <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                  ...
                                  <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                      <li class="sa-nav__menu-item"><a href="{{ route('admin.product.list') }}"
                                              class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span
                                                  class="sa-nav__title">Products List</span></a></li>
                                      <li class="sa-nav__menu-item"><a href="{{ route('admin.product.create') }}"
                                              class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span
                                                  class="sa-nav__title">Product</span></a></li>
                                      <li class="sa-nav__menu-item"><a href="{{ route('admin.category.list') }}"
                                              class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span
                                                  class="sa-nav__title">Categories List</span></a></li>
                                      <li class="sa-nav__menu-item"><a href="{{ route('admin.subcategory.list') }}"
                                              class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span
                                                  class="sa-nav__title">subcategory List</span></a></li>
                                      <li class="sa-nav__menu-item"><a href="{{ route('admin.brand.list') }}"
                                              class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span
                                                  class="sa-nav__title">Brand List</span></a></li>
                                      {{-- <li class="sa-nav__menu-item"><a href="app-category.html"
                                              class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span
                                                  class="sa-nav__title">Category</span></a></li> --}}
                                      <li class="sa-nav__menu-item"><a href="{{ route('admin.color.list') }}"
                                              class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span
                                                  class="sa-nav__title">Colors List</span></a></li>
                                      {{-- <li class="sa-nav__menu-item"><a href="{{ route('admin.color.list') }}"
                                              class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span
                                                  class="sa-nav__title">Images List</span></a></li> --}}
                                      <li class="sa-nav__menu-item"><a href="{{ route('admin.slider.list') }}"
                              ...
                              <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                  data-sa-collapse-item="sa-nav__menu-item--open"><a href=""
                                      ...
                                      </span><span class="sa-nav__title">Bài viết</span><span
                              ...
                              {{-- <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                  data-sa-collapse-item="sa-nav__menu-item--open"><a href=""
                                      ...
                                      <span class="sa-nav__title">Danh mục sản phẩm </span><span
                                          class="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg"
                                              width="6" height="9" viewBox="0 0 6 9" fill="currentColor">
                                              <path
                                                  d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                                  ...
                                  <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                      <li class="sa-nav__menu-item"><a href="{{ route('admin.category.list') }}"
                                              class="sa-nav__link"><span
                                                  class="sa-nav__menu-item-padding"></span><span
                                                  class="sa-nav__title">Quản lý danh mục</span></a></li>
                              ...
                              {{-- <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                  data-sa-collapse-item="sa-nav__menu-item--open"><a href=""
                                      ...
                                      </span><span class="sa-nav__title">Danh mục con</span><span
                                          class="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg"
                                              width="6" height="9" viewBox="0 0 6 9" fill="currentColor">
                                              <path
                                                  d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                                  ...
                                  <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                      <li class="sa-nav__menu-item"><a href="{{ route('admin.subcategory.list') }}"
                                              class="sa-nav__link"><span
                                                  class="sa-nav__menu-item-padding"></span><span
                                                  class="sa-nav__title">Quản lý danh mục con</span></a></li>
                              ...
                              <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                  data-sa-collapse-item="sa-nav__menu-item--open"><a href=""
                                      class="sa-nav__link" data-sa-collapse-trigger=""><span class="sa-nav__icon">
                                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" id="dairy">
                                              <path
                                                  d="M12 25.50037c-.02197-1.31421-1.97803-1.31458-2 0v1c.02203 1.31421 1.97809 1.31458 2-.00006 0 .00006 0-.99994 0-.99994zM10 30.50037v1c.02203 1.31421 1.97809 1.31458 2-.00006 0 .00006 0-.99994 0-.99994-.02197-1.31421-1.97803-1.31458-2 0zM13 27.50037c-1.31415.02191-1.31451 1.97815 0 2h1c1.31421-.02191 1.31451-1.97815 0-2h-1zM8 27.50037c-1.31415.02191-1.31451 1.97815.00006 2-.00006 0 .99994 0 .99994 0 1.31421-.02191 1.31451-1.97815 0-2h-1zM22 15.50037c-.02197-1.31421-1.97803-1.31458-2 0v1c.02203 1.31421 1.97809 1.31458 2-.00006 0 .00006 0-.99994 0-.99994zM20 20.50037v1c.02203 1.31421 1.97809 1.31458 2-.00006 0 .00006 0-.99994 0-.99994-.02197-1.31421-1.97803-1.31458-2 0zM23 17.50037c-1.31415.02191-1.31451 1.97815 0 2h1c1.31421-.02191 1.31451-1.97815 0-2h-1zM18 17.50037c-1.31415.02191-1.31451 1.97815.00006 2-.00006 0 .99994 0 .99994 0 1.31421-.02191 1.31451-1.97815 0-2h-1zM59.69769 20.59058l-2.56494-5.98486c1.86255-1.79211.48853-5.1629-2.13281-5.10529.00006-.00006-22.99994-.00006-22.99994-.00006-2.57721-.05762-3.98682 3.23822-2.1795 5.04871l-3.43842 6.01727c-1.3559.28705-2.38208 1.49585-2.38208 2.93402v6.16064l1.84277-.46045c2.3736-.64172 4.99603.45215 6.28223 2.50635 5.30475-6.3587 15.87018-2.58356 15.875 5.79358.11829 6.55151-7.22052 11.0874-13 8.04919v.07764c4.14581 1.09802 3.47711 6.53827.88947 8.87305h23.11053c1.6543 0 3-1.3457 3-3v-28c0-1.41302-.98499-2.59338-2.30231-2.90979zm-27.69769-9.09021h23c1.30664.02094 1.32019 1.9762-.00006 2 .00006 0-22.99994 0-22.99994 0-1.30658-.02094-1.32013-1.97626 0-2zm-3.27686 9l2.85693-5h22.90375l-2.14288 5h-23.6178zm31.27686 31c0 .55176-.44873 1-1 1h-5.17139c.09662-.32629.17377-.65338.17139-1v-29h5c.55127 0 1 .44824 1 1v28z" />
                                              <path
                                                  d="M47.83154 17.46131c-.58856.76276-1.89026.54938-2.2002-.3653-.18799-.51947-.76025-.79095-1.28027-.60052-.51953.1875-.78809.76074-.60059 1.28027.45203 1.26227 1.71936 2.1709 3.06445 2.16309.98486 0 1.95654-.45215 2.57715-1.22559.81226-1.02441-.73566-2.2663-1.56055-1.25195zM58 44.50037h-2c-1.31384.02179-1.31476 1.97809.00006 2-.00006 0 1.99994 0 1.99994 0 1.3139-.02185 1.31476-1.97815 0-2zM58 48.50037h-2c-1.31384.02179-1.31476 1.97809.00006 2-.00006 0 1.99994 0 1.99994 0 1.3139-.02185 1.31476-1.97815 0-2zM34 47.50037h-1v-8c0-.90094-.29974-1.74323-.84338-2.42615l-1.33972-3.57385c-.68115-1.82324-2.61328-2.84277-4.48926-2.35938l-17.5304 4.37982c-2.11365.10773-3.79724 1.83899-3.79724 3.97955v8h-1c-1.10303 0-2 .89746-2 2 0 2.75684 2.24316 5 5 5h24c2.75684 0 5-2.24316 5-5 0-1.10254-.89697-2-2-2zm-7.18408-14.4209c.89062-.22363 1.80518.25586 2.12744 1.12109l.49658 1.32422c-.14551-.0166-.29248-.02441-.43994-.02441h-11.87207l9.68799-2.4209zm2.18408 8.9209c-.14685 4.62543-6.85382 4.62433-7-.00012.14691-4.62537 6.85382-4.62427 7 .00012zm-12.5-.5c3.297.08447 3.29633 4.91595-.00006 5-3.29694-.08453-3.29626-4.91602.00006-5zm-7.95996-3.94c-.04785-.11505 4.74506-.04022 4.90997-.06.54297 3.91907-5.36389 3.98401-4.90997.06zm22.45996 14.94H7c-1.6543 0-3-1.3457-3-3h30c0 1.6543-1.3457 3-3 3z" />
                                          </svg>
                                      </span><span class="sa-nav__title">Sản phẩm</span><span
                                          class="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg"
                                              width="6" height="9" viewBox="0 0 6 9" fill="currentColor">
                                              <path
                                                  d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                                  ...
                                  <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                      <li class="sa-nav__menu-item"><a href="{{ route('admin.product.list') }}"
                                              class="sa-nav__link"><span
                                                  class="sa-nav__menu-item-padding"></span><span
                                                  class="sa-nav__title">Danh sách sản phẩm</span></a></li>
                              ...
                              <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                  data-sa-collapse-item="sa-nav__menu-item--open"><a href=""
                                      class="sa-nav__link" data-sa-collapse-trigger=""><span class="sa-nav__icon">
                                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" id="picture">
                                              <path
                                                  d="M61.68 54.91H2.32C1.04 54.91 0 53.87 0 52.59V11.41c0-1.28 1.04-2.32 2.32-2.32h59.36c1.28 0 2.32 1.04 2.32 2.32v41.18c0 1.28-1.04 2.32-2.32 2.32zM4.64 50.27h54.72V13.73H4.64v36.54z" />
                                              <path
                                                  d="M61.68 54.91c-.69 0-1.38-.31-1.84-.9l-10.7-13.84-6.59 6.59c-.87.87-2.41.87-3.28 0l-15.8-15.81L4.1 54.08c-.82.98-2.28 1.11-3.27.29a2.326 2.326 0 0 1-.29-3.27l21-25.07c.42-.5 1.03-.8 1.68-.83.65-.02 1.28.22 1.74.68l15.96 15.96 6.81-6.81a2.29 2.29 0 0 1 1.79-.67c.66.04 1.28.37 1.69.9l12.32 15.92c.78 1.01.6 2.47-.42 3.25-.43.32-.93.48-1.43.48z" />
                                              <path
                                                  d="M32 37.98c-.27 0-.55-.01-.81-.04a2.33 2.33 0 0 1-2.08-2.54 2.323 2.323 0 0 1 2.54-2.08c.11.01.23.02.34.02 2.05 0 3.71-1.66 3.71-3.71s-1.66-3.71-3.71-3.71-3.71 1.66-3.71 3.71c0 .12.01.24.02.36a2.321 2.321 0 0 1-4.62.44c-.03-.27-.04-.53-.04-.8 0-4.6 3.75-8.35 8.35-8.35s8.35 3.75 8.35 8.35-3.74 8.35-8.34 8.35z" />
                                          </svg>
                                      </span><span class="sa-nav__title">Biến thể sản phẩm </span><span
                                          class="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg"
                                              width="6" height="9" viewBox="0 0 6 9" fill="currentColor">
                                              <path
                                                  d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                                  ...
                                  <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                      <li class="sa-nav__menu-item"><a href="{{ route('admin.variants.list') }}"
                                              class="sa-nav__link"><span
                                                  class="sa-nav__menu-item-padding"></span><span
                                                  class="sa-nav__title">Danh sách biến thể</span></a></li>
                              ...
                              <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                  data-sa-collapse-item="sa-nav__menu-item--open"><a href=""
                                      ...
                                      </span><span class="sa-nav__title">Thương hiệu</span><span
                                          class="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg"
                                              width="6" height="9" viewBox="0 0 6 9" fill="currentColor">
                                              <path
                                                  d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                                  ...
                                  <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                      <li class="sa-nav__menu-item"><a href="{{ route('admin.brand.list') }}"
                                              class="sa-nav__link"><span
                                                  class="sa-nav__menu-item-padding"></span><span
                                                  class="sa-nav__title">Danh sách thương hiệu</span></a></li>
                              ...
                              <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                  data-sa-collapse-item="sa-nav__menu-item--open"><a href=""
                                      ...
                                      </span><span class="sa-nav__title">Mã giảm giá</span><span
                                          class="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg"
                                              width="6" height="9" viewBox="0 0 6 9" fill="currentColor">
                                              <path
                                                  d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                                  ...
                                  <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                      <li class="sa-nav__menu-item"><a href="{{ route('admin.coupon.list') }}"
                                              class="sa-nav__link"><span
                                                  class="sa-nav__menu-item-padding"></span><span
                                                  class="sa-nav__title">Danh sách giảm giá</span></a></li>
                              ...
                              <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                  ...
                                  <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                      <li class="sa-nav__menu-item"><a href="{{ route('admin.slider.list') }}"
                                              class="sa-nav__link"><span
                                                  class="sa-nav__menu-item-padding"></span><span
                                                  class="sa-nav__title">Danh mục Sliders </span></a></li>
                              ...
                              <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                  data-sa-collapse-item="sa-nav__menu-item--open"><a href=""
                                      class="sa-nav__link" data-sa-collapse-trigger=""><span
                                          ...
                                          </svg></span><span class="sa-nav__title">Người dùng</span><span
                                          class="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg"
                                              width="6" height="9" viewBox="0 0 6 9" fill="currentColor">
                                              <path
                                                  d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                              ...
                              <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                  data-sa-collapse-item="sa-nav__menu-item--open"><a href=""
                                      class="sa-nav__link" data-sa-collapse-trigger=""><span
                                          ...
                                          </svg></span><span class="sa-nav__title">Đơn hàng </span><span
                                          class="sa-nav__arrow"><svg xmlns="http://www.w3.org/2000/svg"
                                              width="6" height="9" viewBox="0 0 6 9" fill="currentColor">
                                              <path
                                                  d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
                                  ...
                                  <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                      <li class="sa-nav__menu-item"><a href="{{ route('admin.order.list') }}"
                                              class="sa-nav__link"><span
                                                  class="sa-nav__menu-item-padding"></span><span
                                                  class="sa-nav__title">Danh sách đơn hàng</span></a></li>
                              ...
                              <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                  data-sa-collapse-item="sa-nav__menu-item--open"><a href=""
                                      class="sa-nav__link" data-sa-collapse-trigger=""><span class="sa-nav__icon">
                                          <svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" width="1em"
                                              ...
                                              <g>
                                                  <path
                                                      d="M48.4,32.7H22.7c-0.9,0-1.6-0.7-1.6-1.6v-3.2c0-0.9,0.7-1.6,1.6-1.6h25.7c0.9,0,1.6,0.7,1.6,1.6v3.2   C50,32,49.3,32.7,48.4,32.7z" />
                                              </g>
                                              <g>
                                                  <path
                                                      d="M13,32.7H9.8c-0.9,0-1.6-0.7-1.6-1.6v-3.2c0-0.9,0.7-1.6,1.6-1.6H13c0.9,0,1.6,0.7,1.6,1.6v3.2   C14.7,32,13.9,32.7,13,32.7z" />
                                              </g>
                                              <g>
                                                  <path
                                                      d="M13,47H9.8c-0.9,0-1.6-0.7-1.6-1.6v-3.2c0-0.9,0.7-1.6,1.6-1.6H13c0.9,0,1.6,0.7,1.6,1.6v3.2   C14.7,46.3,13.9,47,13,47z" />
                                              </g>
                                              <g>
                                                  <path
                                                      d="M48.4,47H22.7c-0.9,0-1.6-0.7-1.6-1.6v-3.2c0-0.9,0.7-1.6,1.6-1.6h25.7c0.9,0,1.6,0.7,1.6,1.6v3.2   C50,46.3,49.3,47,48.4,47z" />
                                              </g>
                                          </svg>
                                  ...
                                  <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                      {{-- <li class="sa-nav__menu-item"><a href="https://ps26819.vercel.app/" class="sa-nav__link"><span class="sa-nav__menu-item-padding"></span><span class="sa-nav__title">Task Manager Redirect</span></a></li> --}}
                                      <li class="sa-nav__menu-item"><a href="{{ route('admin.task-manager') }}"
                                              class="sa-nav__link"><span
                                                  class="sa-nav__menu-item-padding"></span><span
                              ...
                              <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                  data-sa-collapse-item="sa-nav__menu-item--open"><a href=""
                                      class="sa-nav__link" data-sa-collapse-trigger=""><span class="sa-nav__icon">
                                          ...
                                          </svg> </span><span class="sa-nav__title">
                                          Hộp thư đến</span><span class="sa-nav__arrow"><svg
                              ...
                              <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"><a
                                      href="{{ route('admin.file-manager') }}" class="sa-nav__link"><span
                                          ...
                                          <svg xmlns="http://www.w3.org/2000/svg" id="file" x="0" y="0"
                                              ...
                                              <path d="M21.5 2h-10v4h3.828l4.172 4.172V21h6V6h-4z" />
                                              <path d="M25.5 5h-3V2zM13.5 8h-10v19h14V12h-4z" />
                                              <path d="M17.5 11h-3V8z" />
                                          </svg>
                                      </span><span class="sa-nav__title">Quản lý File</span></a></li>
                              <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"><a
                                      ...
                                      </span><span class="sa-nav__title">Quản lý Database</span></a></li>
                              {{-- <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"><a
                              ...
                              {{-- <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"><a
                                      href="{{ route('admin.design.database') }}" class="sa-nav__link"><span
                                          ...
                                          </svg></span><span class="sa-nav__title">Relationship
                                          Diagram</span></a></li> --}}
                              {{-- <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"><a
...
{{-- 
                              <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                  data-sa-collapse-item="sa-nav__menu-item--open"><a href=""
                                      class="sa-nav__link" data-sa-collapse-trigger=""><span
                                          class="sa-nav__icon"><img src="/github-mark-white.svg" alt=""
                                              srcset=""></span><span
                                          class="sa-nav__title">Information</span><span class="sa-nav__arrow"><svg
                                              xmlns="http://www.w3.org/2000/svg" width="6" height="9"
                                              viewBox="0 0 6 9" fill="currentColor">
                                              <path
                                                  d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z">
