                        ...
                        <ul class="list-unstyled">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <a href="{{ route("fe.shop") }}" class="d-block width-75">
                                            <img class="img-fluid" src="{{ asset('client/img/300X300/nu1.jpg') }}"
                                                alt="Image Description">
                                        </a>
                                    </div>
                                    <div class="col">
                                        <h3 class="text-lh-1dot2 font-size-14 mb-0"><a
                                                href="{{ route("fe.shop") }}">Watch Black Spire V Nitro
                                                VN7-591G</a></h3>
                            ...
                            <li class="mb-4">
                                <div class="row">
                                    <div class="col-auto">
                                        <a href="{{ route("fe.shop") }}" class="d-block width-75">
                                            <img class="img-fluid" src="{{ asset('client/img/300X300/nu2.jpg') }}"
                                                alt="Image Description">
                                        </a>
                                    </div>
                                    <div class="col">
                            ...
                            <li class="mb-4">
                                <div class="row">
                                    <div class="col-auto">
                                        <a href="{{ route("fe.shop") }}" class="d-block width-75">
                                            <img class="img-fluid" src="{{ asset('client/img/300X300/nu3.jpg') }}"
                                                alt="Image Description">
                                        </a>
                                    </div>
                                    <div class="col">
                                        <h3 class="text-lh-1dot2 font-size-14 mb-0"><a
                                                href="{{ route("fe.shop") }}">Watch Thin EliteBook Revolve
                                                810 G6</a></h3>
                                        <div class="text-warning text-ls-n2 font-size-16 mb-1" style="width: 80px;">
                                            <small class="fas fa-star"></small>
                                            <small class="fas fa-star"></small>
                            ...
                            <li class="mb-4">
                                <div class="row">
                                    <div class="col-auto">
                                        <a href="{{ route("fe.shop") }}" class="d-block width-75">
                                            <img class="img-fluid" src="{{ asset('client/img/300X300/nu4.jpg') }}"
                                                alt="Image Description">
                                        </a>
                                    </div>
                                    <div class="col">
                                        <h3 class="text-lh-1dot2 font-size-14 mb-0"><a
                                                href="{{ route("fe.shop") }}">Watch Purple
                                                G952VX-T7008T</a></h3>
                                        <div class="text-warning text-ls-n2 font-size-16 mb-1" style="width: 80px;">
                                            <small class="fas fa-star"></small>
                                            <small class="fas fa-star"></small>
                            ...
                            <li class="mb-4">
                                <div class="row">
                                    <div class="col-auto">
                                        <a href="{{ route("fe.shop") }}" class="d-block width-75">
                                            <img class="img-fluid" src="{{ asset('client/img/300X300/inu5.jpg') }}"
                                                alt="Image Description">
                                        </a>
                                    </div>
                                    <div class="col">
                                        <h3 class="text-lh-1dot2 font-size-14 mb-0"><a
                                                href="{{ route("fe.shop") }}">Watch  Yoga 21 80JH0035GE
                                                W8.1</a></h3>
                                        <div class="text-warning text-ls-n2 font-size-16 mb-1" style="width: 80px;">
                                            <small class="fas fa-star"></small>
                                            <small class="fas fa-star"></small>
                                        ...
                                        <div class="product-item__body pb-xl-2">
                                            <div class="mb-2">
                                                <a href="{{ route('frontend.category.products', ['category_slug' => $currentCategory[0]->slug, 'sub_slug' => $item->slug]) }}"
                                                    ...
                                                    height: 200px;
                                                    object-fit: contain;
                                                "  src="{{ $item->image ? asset('storage/' . $item->image)   : asset('client/img/300X300/nam8.jpg')}}"
                                                ...
                                                <div class="col col-lg-auto product-media-left">
                                                    <a href="{{ route("fe.shop") }}"
                                                        class="max-width-150 d-block"><img class="img-fluid"
                                                            src="{{ asset('client/img/150X140/nam1.jpg') }}"
                                                            alt="Image Description"></a>
                                                </div>
                                                <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                    <div class="mb-4">
                                                        <div class="mb-2"><a href="#"
                                                                class="font-size-12 text-gray-5">Watch</a></div>
                                                        <h5 class="product-item__title"><a
                                                                href="{{ route("fe.shop") }}"
                                                                class="text-blue font-weight-bold">Watch Air 3 WiFi 64GB
                                                                Gold</a></h5>
                                                    </div>
                                        ...
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner p-md-3 row no-gutters">
                                                <div class="col col-lg-auto product-media-left">
                                                    <a href="{{ route("fe.shop") }}"
                                                        class="max-width-150 d-block"><img class="img-fluid"
                                                            src="{{ asset('client/img/150X140/nam8.jpg') }}"
                                                            alt="Image Description"></a>
                                                </div>
                                                <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                    <div class="mb-4">
                                                        <div class="mb-2"><a href="#"
                                                                class="font-size-12 text-gray-5">Watch CASIO</a>
                                                        </div>
                                                        <h5 class="product-item__title"><a
                                                                href="{{ route("fe.shop") }}"
                                                                class="text-blue font-weight-bold">Watch White EliteBook
                                                                Revolve 810 G2</a></h5>
                                                    </div>
                                                    <div class="flex-center-between mb-3">
                                                        <div class="prodcut-price">
                                        ...
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner p-md-3 row no-gutters">
                                                <div class="col col-lg-auto product-media-left">
                                                    <a href="{{ route("fe.shop") }}"
                                                        class="max-width-150 d-block"><img class="img-fluid"
                                                            src="{{ asset('client/img/150X140/nam9.jpg') }}"
                                                            alt="Image Description"></a>
                                                </div>
                                                <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                    <div class="mb-4">
                                                        <div class="mb-2"><a href="#"
                                                                class="font-size-12 text-gray-5">Rolex Watch</a></div>
                                                        <h5 class="product-item__title"><a
                                                                href="{{ route("fe.shop") }}"
                                                                class="text-blue font-weight-bold">Watch  Solo 2
                                                                Wireless</a></h5>
                                                    </div>
                                                    <div class="flex-center-between mb-3">
                                                        <div class="prodcut-price">
                                        ...
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner p-md-3 row no-gutters">
                                                <div class="col col-lg-auto product-media-left">
                                                    <a href="{{ route("fe.shop") }}"
                                                        class="max-width-150 d-block"><img class="img-fluid"
                                                            src="{{ asset('client/img/150X140/nam4.jpg') }}"
                                                            alt="Image Description"></a>
                                                </div>
                                                <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                    <div class="mb-4">
                                        ...
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner p-md-3 row no-gutters">
                                                <div class="col col-lg-auto product-media-left">
                                                    <a href="{{ route("fe.shop") }}"
                                                        class="max-width-150 d-block"><img class="img-fluid"
                                                            src="{{ asset('client/img/150X140/nam6.jpg') }}"
                                                            alt="Image Description"></a>
                                                </div>
                                                <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                    <div class="mb-4">
                                                        <div class="mb-2"><a href="#"
                                                                class="font-size-12 text-gray-5">Watch man</a>
                                                        </div>
                                                        <h5 class="product-item__title"><a
                                                                href="{{ route("fe.shop") }}"
                                                                class="text-blue font-weight-bold">Watch White EliteBook
                                        ...
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner p-md-3 row no-gutters">
                                                <div class="col col-lg-auto product-media-left">
                                                    <a href="{{ route("fe.shop") }}"
                                                        class="max-width-150 d-block"><img class="img-fluid"
                                                            src="{{ asset('client/img/150X140/nam7.jpg') }}"
                                                            alt="Image Description"></a>
                                                </div>
                                                <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                    <div class="mb-4">
                                                        <div class="mb-2"><a href="#"
                                                                class="font-size-12 text-gray-5">Watch women</a></div>
                                                        <h5 class="product-item__title"><a
                                                                href="{{ route("fe.shop") }}"
                                        ...
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner p-md-3 row no-gutters">
                                                <div class="col col-lg-auto product-media-left">
                                                    <a href="{{ route("fe.shop") }}"
                                                        class="max-width-150 d-block"><img class="img-fluid"
                                                            src="{{ asset('client/img/150X140/nam10.jpg') }}"
                                                            alt="Image Description"></a>
                                                </div>
                                                <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                    <div class="mb-4">
                                        ...
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner p-md-3 row no-gutters">
                                                <div class="col col-lg-auto product-media-left">
                                                    <a href="{{ route("fe.shop") }}"
                                                        class="max-width-150 d-block"><img class="img-fluid"
                                                            src="{{ asset('client/img/150X140/nam5.jpg') }}"
                                                            alt="Image Description"></a>
                                                </div>
                                                <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                                    <div class="mb-4">
