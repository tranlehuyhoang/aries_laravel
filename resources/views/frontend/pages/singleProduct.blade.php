    ...
    <main id="content" role="main">
        ...
        <div class="container">
            ...
            <div class="mb-xl-14 mb-6">
                <div class="row">
                    <div class="col-md-5 mb-4 mb-md-0" style="position: relative;">
                        <div class=""
                            style="
                        ...
                        <div class="mb-2">
                            <div class="border-bottom mb-3 pb-md-1 pb-3">
                                ...
                                <div class="d-md-flex align-items-center">
                                    ...
                                    <div class="  text-gray-9 font-size-14">Tình trạng:
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    <img class="img-fluid mr-n4 mr-lg-n10"
                                        src="{{ asset('client/img/580X580/img4.jpg') }}" alt="Image Description">
                                </div>
                            ...
                            <div class="product-item__inner px-xl-4 p-3">
                                <div class="product-item__body pb-xl-2">
                                    ...
                                    <h5 class="mb-1 product-item__title"><a href="{{ route('fe.shop') }}"
                                            class="text-blue font-weight-bold">Watch Pro AKS 2024
                                            Full base audio</a></h5>
                                    <div class="mb-2">
                                        <a href="{{ route('fe.shop') }}" class="d-block text-center"><img
                                                class="img-fluid" src="{{ asset('client/img/212X200/nam4.jpg') }}"
                            ...
                            <div class="product-item__inner px-xl-4 p-3">
                                <div class="product-item__body pb-xl-2">
                                    <div class="mb-2"><a href="../shop/product-categories-7-column-full-width.html"
                                            class="font-size-12 text-gray-5">Speakers</a></div>
                                    <h5 class="mb-1 product-item__title"><a href="{{ route('fe.shop') }}"
                                            class="text-blue font-weight-bold">Watch White EliteBook Revolve 810 G2</a>
                                    </h5>
                                    <div class="mb-2">
                                        <a href="{{ route('fe.shop') }}" class="d-block text-center"><img
                                                class="img-fluid" src="{{ asset('client/img/212X200/nam5.jpg') }}"
                                                alt="Image Description"></a>
                                    </div>
                                    <div class="flex-center-between mb-1">
                            ...
                            <div class="product-item__inner px-xl-4 p-3">
                                <div class="product-item__body pb-xl-2">
                                    <div class="mb-2"><a href="../shop/product-categories-7-column-full-width.html"
                                            class="font-size-12 text-gray-5">Speakers</a></div>
                                    <h5 class="mb-1 product-item__title"><a href="{{ route('fe.shop') }}"
                                            class="text-blue font-weight-bold">Purple Solo 2 Watch</a></h5>
                                    <div class="mb-2">
                                        <a href="{{ route('fe.shop') }}" class="d-block text-center"><img
                                                class="img-fluid" src="{{ asset('client/img/212X200/nam1.jpg') }}"
                                                alt="Image Description"></a>
                                    </div>
                                    <div class="flex-center-between mb-1">
                                        <div class="prodcut-price">
                            ...
                            <div class="product-item__inner px-xl-4 p-3">
                                <div class="product-item__body pb-xl-2">
                                    <div class="mb-2"><a href="../shop/product-categories-7-column-full-width.html"
                                            class="font-size-12 text-gray-5">Speakers</a></div>
                                    <h5 class="mb-1 product-item__title"><a href="{{ route('fe.shop') }}"
                                            class="text-blue font-weight-bold">Apple Watch</a></h5>
                                    <div class="mb-2">
                                        <a href="{{ route('fe.shop') }}" class="d-block text-center"><img
                                                class="img-fluid" src="{{ asset('client/img/212X200/nam7.jpg') }}"
                                                alt="Image Description"></a>
                                    </div>
                                    <div class="flex-center-between mb-1">
                                        <div class="prodcut-price">
                            ...
                            <div class="product-item__inner px-xl-4 p-3">
                                <div class="product-item__body pb-xl-2">
                                    <div class="mb-2"><a href="../shop/product-categories-7-column-full-width.html"
                                            class="font-size-12 text-gray-5">Speakers</a></div>
                                    <h5 class="mb-1 product-item__title"><a href="{{ route('fe.shop') }}"
                                            class="text-blue font-weight-bold">Watch rolex man 2024</a></h5>
                                    <div class="mb-2">
                                        <a href="{{ route('fe.shop') }}" class="d-block text-center"><img
                                                class="img-fluid" src="{{ asset('client/img/212X200/nam3.jpg') }}"
                                                alt="Image Description"></a>
                                    </div>
                                    <div class="flex-center-between mb-1">
                                        <div class="prodcut-price">
                            ...
                            <div class="product-item__inner px-xl-4 p-3">
                                <div class="product-item__body pb-xl-2">
                                    <div class="mb-2"><a href="../shop/product-categories-7-column-full-width.html"
                                            class="font-size-12 text-gray-5">Speakers</a></div>
                                    <h5 class="mb-1 product-item__title"><a href="{{ route('fe.shop') }}"
                                            class="text-blue font-weight-bold">Watch casio 2024 new</a>
                                    </h5>
                                    <div class="mb-2">
                                        <a href="{{ route('fe.shop') }}" class="d-block text-center"><img
                                                class="img-fluid" src="{{ asset('client/img/212X200/nam6.jpg') }}"
                                                alt="Image Description"></a>
                                    </div>
                                    <div class="flex-center-between mb-1">
                                        <div class="prodcut-price d-flex align-items-center position-relative">
