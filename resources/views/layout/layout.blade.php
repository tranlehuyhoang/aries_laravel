...
<head>
    ...
    <meta name="description" content="Welcome to our Electro website. We offer a wide range of electronic products, including smartphones, laptops, gaming monitors, and earphones. Explore our latest arrivals and take advantage of our end-of-season sale.">
    <!-- Favicon -->
    ...
    {{-- <script type="text/javascript">
        (function(d, t) {
            ...
            v.onload = function() {
              window.voiceflow.chat.load({
                verify: { projectID: '66e0446d07c0b3b6adc81de5' },
      ...
      <script type="text/javascript">
        (function(d, t) {
            ...
            v.onload = function() {
              window.voiceflow.chat.load({
                verify: { projectID: '66f0d11c3f8fe0e3b26d5703' },
                url: 'https://general-runtime.voiceflow.com',
                versionID: 'production'
              });
            }
